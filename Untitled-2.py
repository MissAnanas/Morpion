...
while True:
    ...
    def main():
        ...
        def check_game_result(array: list[list[int]], symbol: int, size: int, win_condition: int, last_move) -> tuple[bool, str]:
            row, col = last_move
        ...
        def make_player_move(array, symbol: int, moves, size, win_condition) -> tuple[bool, tuple[int, int]]:
            while True:
        ...
        def find_winning_move(array, moves, size, win_condition, symbol, last_move):
            for move in moves:
                ...
                if check_game_result(array, symbol, size, win_condition, move)[0]:
